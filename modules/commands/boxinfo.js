...
module.exports.run = async function({ api, event, args }) {
	...
	let sex = threadInfo.approvalMode;
			...
			var callback = () =>
				api.sendMessage(
					{
						body: `🔧 GC Name: ${threadName}\n🔧 Group ID: ${id}\n🔧 Approval: ${pd}\n🔧 Emoji: ${icon}\n🔧 Information: including ${threadMem} members\n🔧 Number of males: ${nam} members\n🔧 Number of females: ${nu} members\n🔧 With ${qtv} administrators\n🔧 Total number of messages: ${sl} msgs.\n\nMade with ❤️ by:  💝🥀𝐎𝐖𝐍𝐄𝐑:- ☞《𝐌R•𝐍𝐈𝐇𝐀𝐋 ⸙• HACKER☜ 💫\n
🖤𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 〠《𝐌R•𝐍𝐈𝐇𝐀𝐋 ⸙• HACKER🖤\n

😳my owner 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝🤓:- ☞ https://www.facebook.com/profile.php?id=61555815587626\n

👋For Any Kind Of Help Contact On Telegram  Username 👉 @MrNihalhacker😇`,
